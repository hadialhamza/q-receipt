...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center p-4 relative overflow-hidden bg-background animate-in fade-in zoom-in duration-500">
      {/* Content Container */}
      ...
      <div className="absolute top-1/4 left-10 opacity-20 dark:opacity-10 animate-pulse delay-1000">
