    ...
    return (
        <div className="max-w-[800px] mx-auto text-black">
            <div className="bg-white">
                ...
                {/* Address */}
                <div className="text-center text-sm text-black whitespace-pre-line">
...
Fax: 02223374062 Email: headoffice@federalinsubd.com Web: www.federalinsubd.com`}
                ...
                <div className="pr-3 text-black">
                            ...
                            <div>
                                <div className="flex m-0">
                                    ...
                                    <div className="basis-7/12">
                                        <div className="float-left pr-[5px]">:</div>
                                        <div className="float-left">{data.issuingOffice || "N/A"}</div>
                                    </div>
                                </div>
                                <div className="flex">
                        ...
                        <div className="flex pr-0">
                            ...
                            <div className="basis-1/2">
                                <div className="flex m-0">
                                    ...
                                    <div className="basis-7/12">
                                        <div className="float-left pl-[3px] pr-[5px]">:</div>
                                        <div className="float-left">{data.classOfInsurance || "N/A"}</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex items-end mb-2">
                        ...
                        <div className="basis-5/6 border-b border-[#333]">{data.sumOf || ""}</div>
                    </div>
                    ...
                    <div className="flex items-end mb-2">
                        ...
                        <div className="basis-1/3 border-b border-[#333]">{data.modeOfPayment || ""}</div>
                        <div className="basis-1/6 text-right">
                            <span>Dated</span>
                        </div>
                        <div className="basis-1/4 border-b border-[#333]">{data.chequeDate || ""}</div>
                    </div>
                    ...
                    <div className="flex items-end mb-2">
                        ...
                        <div className="basis-5/6 border-b border-[#333]">{data.drawnOn || ""}</div>
                    </div>
                    ...
                    <div className="flex items-end mb-2">
                        ...
                        <div className="basis-5/6 border-b border-[#333]">{data.issuedAgainst || ""}</div>
                    </div>
                            ...
                            <table className="w-full text-black">
                                <tbody>
                                    <tr className="border border-[#333]">
                                        <td className="p-[3px_9px] border border-[#333] w-[40%] pl-2">Premium</td>
                                        <td className="p-[3px_9px] border border-[#333] w-[15%] text-center">BDT</td>
                                    ...
                                    <tr className="border border-[#333]">
                                        <td className="p-[3px_9px] border border-[#333] pl-2">Vat</td>
                                        <td className="p-[3px_9px] border border-[#333] text-center">BDT</td>
                                        <td className="p-[3px_9px] border border-[#333] text-right pr-2">
                                    ...
                                    <tr className="bg-[lightgray] border border-[#333]">
                                        <td className="p-[3px_9px] border border-[#333] pl-2">Total</td>
                                        <td className="p-[3px_9px] border border-[#333] text-center">BDT</td>
                                        <td className="p-[3px_9px] border border-[#333] text-right pr-2">
                    ...
                    <div className="-ml-[1px] -mr-[13px]">
                        <div className="text-center bg-[lightgray] p-[5px] text-black">
