...
export default function DownloadPDFButton({ shortCode, data }) {
    ...
    const handleDownload = async () => {
        ...
        try {
            ...
            doc.text(`Issuing Office        : ${data?.issuingOffice || "N/A"}`, margin, yPos);
            yPos += 6;
            ...
            const drawField = (label, value) => {
                ...
                doc.line(margin + labelWidth + 2, yPos + 1, pageWidth - margin, yPos + 1);
            ...
            doc.line(tableX + col1Width + col2Width, yPos, tableX + col1Width + col2Width, yPos + rowHeight);
            doc.text("Premium", tableX + 2, yPos + 5);
            doc.text("BDT", tableX + col1Width + (col2Width / 2), yPos + 5, { align: "center" });
            doc.text(formatAmount(data?.premium), tableX + col1Width + col2Width + col3Width - 2, yPos + 5, { align: "right" });
            ...
            doc.text("BDT", tableX + col1Width + (col2Width / 2), yPos + 5, { align: "center" });
            doc.text(formatAmount(data?.vat), tableX + col1Width + col2Width + col3Width - 2, yPos + 5, { align: "right" });
            ...
            doc.text("BDT", tableX + col1Width + (col2Width / 2), yPos + 5, { align: "center" });
            doc.text(formatAmount(data?.total), tableX + col1Width + col2Width + col3Width - 2, yPos + 5, { align: "right" });
